...
function TopSection() {
  return (
    ...
    <div className='w-full md:w-[60vw] md:mx-auto h-[90vh] shadow-md shadow-neutral-200 bg-gradient-to-br from-transparent via-white via-neutral-100 to-neutral-300 rounded-md  flex flex-col items-center justify-center  gap-5  dark:bg-none dark:shadow-none'>
      ...
      <button className='w-[150px] h-fit px-3 py-1 text-lg bg-gradient-to-b from-purple-500 to-purple-200 font-bold  rounded-md border-none shadow-md shadow-purple-800 text-neutral-900 font-oleo'>
Analyse Now
      </button>
    </div>
  </div>
